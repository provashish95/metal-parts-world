            ...
            <div className="row my-5">
                <div className="col py-3">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            <h5><span><i class="fa-solid fa-circle-arrow-right"></i></span> How will we improve the performance of a React Application?</h5>
                            ...
                            <h5><span><i class="fa-solid fa-circle-arrow-right"></i></span> What are the different ways to manage a state in a React application?</h5>
                            <p>React components have a built-in state object. The state is encapsulated data where you store assets that are persistent between component renderings. The state is just a fancy term for a JavaScript data structure.5 Types of Application State in React and How They Help in State Management. Data State
                                ...
                                Location State
                                Conclusion.</p>
                            <h5> <span><i class="fa-solid fa-circle-arrow-right"></i></span> How does prototypical inheritance work?</h5>
                            ...
                            <h5><span><i class="fa-solid fa-circle-arrow-right"></i></span> Why we do not set the state directly in React</h5>
                            ...
                            <h5> <span><i class="fa-solid fa-circle-arrow-right"></i></span> What is a unit test? Why should write unit tests?</h5>
